...
bravojs.url = window.location.protocol + '//' + window.location.host + '/extjs4-ace/Component/F7F06C365F61D074DA2CEAC571C46A28@/worker.js';
...
bravojs.mainContext = bravojs.mainModuleDir + '/8CADB03CEB3D2AA2CED325F428D56A29';
...
bravojs.module.constructor.prototype.load = function packages_loader_load(moduleIdentifier, callback)
{
    ...
    var lookupURI = uri;
    if (/\.js$/.test(lookupURI) && !plugin) {
        lookupURI = lookupURI.substring(0, lookupURI.length-3);
    } else
    if(plugin) {
        lookupURI = plugin + "!" + lookupURI;
    	
    }
    
    
    // TODO: Fix `../` as well
    lookupURI = lookupURI.replace(/\/\.\//g, "/");
    ...
    if (!/\.js$/.test(uri) && !/\/$/.test(uri) && !plugin) {
        uri += ".js";
    } else
    if(plugin) {
        uri += "~" + plugin;
...
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/8CADB03CEB3D2AA2CED325F428D56A29@/package.json'), [], function() { return {"uid":"http://github.com/cadorn/ace-extjs/packages/extjs4-ace/","name":"extjs4-ace","main":"lib/component.js","contexts":{"top":{"/lib/component":{"include":{"github.com/cadorn/ace-extjs/packages/extjs-ace/":{}}}}},"mappings":{"extjs-ace":{"location":"" + bravojs.mainModuleDir + "/B6D9CDAF8C5A627C5EF0A5FAEE4979AF","uid":"github.com/cadorn/ace-extjs/packages/extjs-ace/"},"ace":{"location":"" + bravojs.mainModuleDir + "/C6EC60C2EDB43751D2D65343D18BD763"},"cockpit":{"location":"" + bravojs.mainModuleDir + "/D72B9D5467DC82DB41617491A1B613F0"},"pilot":{"location":"" + bravojs.mainModuleDir + "/1B98B0E20B7B60434C721D017DE888F4"}}}; });
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/8CADB03CEB3D2AA2CED325F428D56A29@/lib/component'), ['extjs-ace/component'], function (require, exports, module)
{
...
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/B6D9CDAF8C5A627C5EF0A5FAEE4979AF@/package.json'), [], function() { return {"uid":"http://github.com/cadorn/ace-extjs/packages/extjs-ace/","name":"extjs-ace","main":"","contexts":{"top":{"/":{"load":{"github.com/cadorn/ace-extjs/packages/ace-editor/":{}}}}},"mappings":{"editor":{"location":"" + bravojs.mainModuleDir + "/3811E0B2D30557A03C7171B8F7D26B8A"},"ace":{"location":"" + bravojs.mainModuleDir + "/C6EC60C2EDB43751D2D65343D18BD763"},"cockpit":{"location":"" + bravojs.mainModuleDir + "/D72B9D5467DC82DB41617491A1B613F0"},"pilot":{"location":"" + bravojs.mainModuleDir + "/1B98B0E20B7B60434C721D017DE888F4","uid":"github.com/ajaxorg/pilot/"}}}; });
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/B6D9CDAF8C5A627C5EF0A5FAEE4979AF@/lib/component'), ['pilot/dom','text!./component.css'], function (require, exports, module)
{
...
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/1B98B0E20B7B60434C721D017DE888F4@/package.json'), [], function() { return {"name":"pilot","description":"Pilot is a small library used in the creation of Ace editor.","version":"0.1.1","homepage":"http://github.com/ajaxorg/pilot","engines":[{"node":">= 0.1.102","teleport":">=0.2.0"}],"author":"Fabian Jakobs <fabian@ajax.org>","main":"lib/pilot/index.js","repository":{"type":"git","url":"http://github.com/ajaxorg/ace.git"},"overlay":{"teleport":{"directories":{"lib":"lib/pilot"}}},"licenses":[{"type":"LGPLv3","url":"http://www.gnu.org/licenses/lgpl-3.0.txt"}],"uid":"https://github.com/ajaxorg/pilot/","directories":{"lib":"lib/pilot"},"mappings":{"pilot":{"location":"" + bravojs.mainModuleDir + "/1B98B0E20B7B60434C721D017DE888F4"}}}; });
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/1B98B0E20B7B60434C721D017DE888F4@/lib/pilot/dom'), [], function (require, exports, module) {
...
require.memoize('text!'+bravojs.realpath(bravojs.mainModuleDir + '/B6D9CDAF8C5A627C5EF0A5FAEE4979AF@/lib/component.css'), [], function () {
return ((typeof bravojs !== "undefined")?bravojs:loader.bravojs).base64decode("Ci54LXV4LWFjZS1lZGl0b3ItcGFuZWwgewogICAgYm9yZGVyLXN0eWxlOiBzb2xpZDsKICAgIGJvcmRlci13aWR0aDogMDsKICAgIGJvcmRlci1jb2xvcjogIzk5YmJlODsKICAgIGJhY2tncm91bmQtY29sb3I6ICNmZmZmZmY7Cn0K");
});
...
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/F7F06C365F61D074DA2CEAC571C46A28@/worker'), ['pilot/event_emitter','pilot/oop','pilot/fixoldbrowsers'], function (require, exports, module)
{
    exports.main = function()
    {
        var console = {
...
__bravojs_loaded_moduleIdentifier = bravojs.realpath(bravojs.mainModuleDir + '/F7F06C365F61D074DA2CEAC571C46A28@/worker');